...
function contact() {
    ...
    s = '<h4 class="contact-place-tile">our offices</h4>' +
        ...
        '<img src="./img/img1.png" alt="place 1"> <br>' +
        ...
        '<i class="fas fa-window-close" onclick="closePlaceInfomation()"></i>' +
        '<img src="./img/img2.png" alt="place 2" id="place-2"> <br>' +
        '<p>Thành phố Hồ Chí Minh</p>' +
        '<span>' +
        ...
        '<i class="fas fa-window-close" onclick="closePlaceInfomation()"></i>' +
        '<img src="./img/img3.png" alt="place 3"> <br>' +
        '<p>Thành phố Hồ Chí Minh</p>' +
        '<span>' +
        ...
        '<i class="fas fa-window-close" onclick="closePlaceInfomation()"></i>' +
        '<img src="./img/img4.png" alt="place 4"> <br>' +
        '<p>Thành phố Hồ Chí Minh</p>' +
        '<span>' +
        ...
        '<img src="./img/img1.png" alt="place 1" id="place-1" onclick="showPlaceInfomation(this)"> <br>' +
        '<p>Thành phố Hồ Chí Minh</p>' +
        '<span>' +
        '105 Bà Huyện Thanh Quan <br>Võ Thị Sáu <br>Quận 3' +
        '</span>' +
        '</div>' +
        '<div class="span-1-of-2">' +
        '<img src="./img/img2.png" alt="place 2" id="place-2" onclick="showPlaceInfomation(this)"> <br>' +
        '<p>Thành phố Hồ Chí Minh</p>' +
        '<span>' +
        '273 An D. Vương <br>Phường 3 <br>Quận 5' +
        '</span>' +
        '</div>' +
        '<div class="span-1-of-2">' +
        '<img src="./img/img3.png" alt="place 3" id="place-3" onclick="showPlaceInfomation(this)"> <br>' +
        '<p>Thành phố Hồ Chí Minh</p>' +
        '<span>' +
        '4 Đ. Tôn Đức Thắng <br>Bến Nghé <br>Quận 1' +
        '</span>' +
        '</div>' +
        '<div class="span-1-of-2">' +
        '<img src="./img/img4.png" alt="place 4" id="place-4" onclick="showPlaceInfomation(this)"> <br>' +
        '<p>Thành phố Hồ Chí Minh</p>' +
        '<span>' +
        '20 Ngô Thời Nhiệm <br>Võ Thị Sáu <br>Quận 3' +
        '</span>' +
        ...
        '<div class="span-1-of-4 right-boder">' +
        '<p>leader</p>' +
        '<h4>nguyễn thành trung</h4>' +
        '<span>086-374-4962</span> <br>' +
        '<span>thanh.trung@TTTT.com</span>' +
        '</div>' +
        '<div class="span-1-of-4 right-boder">' +
        '<p>member</p>' +
        '<h4>nguyễn phước toàn</h4>' +
        '<span>354-341-2750</span> <br>' +
        '<span>phuoc.toan@TTTT.com</span>' +
        '</div>' +
        '<div class="span-1-of-4 right-boder">' +
        '<p>member</p>' +
        '<h4>lương quý tuấn</h4>' +
        '<span>531-403-0376</span> <br>' +
        '<span>quy.tuan@TTTT.com</span>' +
        '</div>' +
        '<div class="span-1-of-4">' +
        '<p>member</p>' +
        '<h4>huỳnh đặng thành trí</h4>' +
        '<span>341-531-2750</span> <br>' +
        '<span>thanh.tri@TTTT.com</span>' +
        '</div>' +
        '</div>' +
        '</div>';
    return s;
...
function product() {
    ...
    string = '<div class="tool" id="page">' +
        '<div class="menuSP">' +
        '<ul>' +
        '<a onclick="xuatList(' + "'all'" + ')"><li>Tất cả sản phầm</li></a>' +
        '<a onclick="xuatList(' + "'caphe'" + ')"><li>Cà phê</li></a>' +
        '<a onclick="xuatList(' + "'da_xay'" + ')"><li>Đá Xay</li></a>' +
        '<a onclick="xuatList(' + "'tra'" + ')"><li>Trà</li></a>' +
        '</ul>' +
        '</div>' +
        ...
        '</ul>' +
        '<ul class="loctheogia">' +
        '<a onclick="xuatList(' + "'gia'" + ',1)"><li>Dưới 35000đ</li></a>' +
        '<a onclick="xuatList(' + "'gia'" + ',2)"><li>35000đ - 50000đ</li></a>' +
        '<a onclick="xuatList(' + "'gia'" + ',3)"><li>Trên 50000đ</li></a>' +
        '</ul>' +
        '</div>' +
        '</div>' +
        ...
        '<div class="option">' +
        '<div>Vui lòng chọn size</div>' +
        '<div>' +
        '<div>' +
        '<input id="sizenho" type="radio" checked name="size" value="nho" onclick="tinhgiatien(0)">' +
        '<span for="nho"> Nhỏ +0đ</span>' +
        '</div>' +
        '<div>' +
        '<input type="radio" name="size" value="vua" onclick="tinhgiatien(1)">' +
        '<span for="vua"> Vừa +6000đ</span>' +
        '</div>' +
        '<div>' +
        '<input type="radio" name="size" value="lon" onclick="tinhgiatien(2)">' +
        '<span for="lon"> Lớn +10000đ</span>' +
        '</div>' +
        '</div>' +
        '</div>' +
...
function blog() {
    var s =
        ...
        '<hr>' +
        '<h2>ForTea.</h2>' +
        '<p>‘ForTea’ is the most loved home base for espresso and discussions. Famously known as TTTT, we' +
